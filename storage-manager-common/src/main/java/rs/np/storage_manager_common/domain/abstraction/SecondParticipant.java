 ...
 * koje ovaj interfejs implementiraju nikakvu obavezu da implementiraju metode, vec je dovoljno
 * da budu tipa {@link SecondParticipant} da bi ucestvovali u poslovnoj saradnji.
 * @author Milan
 * @since 1.0.0
 */
